    ...
    <nav className="w-full bg-white h-[60px] px-4 md:h-[90px] flex items-center">
      <div className="container mx-auto flex items-center justify-between">
        <div className="relative flex pr-4">
          ...
          <span className="absolute bottom-2.5 right-1">
            <ElipseIcon />
          </span>
        </div>
        ...
        <div className="hidden md:flex items-center gap-20">
          ...
          <div className="flex gap-6">
            <button className="w-[126px] h-[50px] flex items-center justify-center text-primary border border-primary rounded-md">
              Login
            </button>
            <button className="w-[126px] h-[50px] flex items-center justify-center bg-primary text-white rounded-md">
              Apply Now!
            </button>
          </div>
        </div>
