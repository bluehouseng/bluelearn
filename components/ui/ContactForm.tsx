  ...
  return (
    <div className="flex items-center justify-center min-h-screen w-full py-20">
      <div className="flex w-max  ">
        <div className="relative max-w-xl flex-1 rounded-l-lg shadow-custom-light">
          <img
        ...
        <div className="relative max-w-xl flex-1 bg-[#2489D3]  text-white flex items-center justify-center rounded-r-lg shadow-custom-light">
